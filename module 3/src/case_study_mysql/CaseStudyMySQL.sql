...
insert into dich_vu(ten_dich_vu, dien_tich, chi_phi_thue, so_nguoi_toi_da, tieu_chuan_phong,
					mo_ta_tien_nghi_khac, so_tang, ma_kieu_thue, ma_loai_dich_vu)
values ('House Princess 01', 14000, 5000000, 7, 'vip', 'Có thêm bếp nướng', 3, 2, 2);
insert into dich_vu(ten_dich_vu, dien_tich, chi_phi_thue, so_nguoi_toi_da, tieu_chuan_phong,
					mo_ta_tien_nghi_khac, ma_kieu_thue, ma_loai_dich_vu)
...
hd.ngay_ket_thuc, sum(ifnull(dv.chi_phi_thue, 0) + ifnull(hdct.so_luong, 0) * ifnull(dvdk.gia, 0)) as tong_tien from dich_vu_di_kem dvdk
...
right join loai_khach lk on kh.ma_loai_khach = lk.ma_loai_khach
